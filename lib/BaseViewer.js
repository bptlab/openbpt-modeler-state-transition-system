...
export default class BaseViewer extends Diagram {
    ...
    return new Promise(function (resolve, reject) {
      ...
      moddle
        ...
        .then(function (result) {
          ...
          self._emit(OlcEvents.DEFINITIONS_CHANGED, {
            definitions: definitions,
          });

          self._emit("import.render.start", { definitions: definitions });
          self.showModel(definitions, definitions.diagrams[0]);
  ...
  showModel(definitions, diagram) {
    this.clear();
    this._model = diagram.plane.modelElement;
    this._emit(OlcEvents.SELECTED_OLC_CHANGED, {
      diagram: diagram,
    });

    importDiagram(this, definitions, diagram);
  }
